...
SUCCESS_GET_WEBSITE = "Website data."
...
SUCCESS_UPDATE_WEBSITE = "Updated website data successfully."
SUCCESS_UPDATE_ORGANIZATION = "Updated organization data successfully."
