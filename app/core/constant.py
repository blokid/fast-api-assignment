...
SUCCESS_GET_USER_ORGANIZATION = "Organization data that the current user is associated."
SUCCESS_GET_USER_WEBSITE = "Website data that the current user is associated."
